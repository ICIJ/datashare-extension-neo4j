...
public class LoggingUtilsTest {
    ...
    private static final LoggingUtils.SyslogServerSingleton syslogServer =
    ...
    public void test_syslog_handler_should_raise_for_invalid_facility() {
        ...
        assertThrowsExactly(
            ...
            () -> new LoggingUtils.SyslogMessageHandler(Neo4jResource.class.getName(), facility,
                splitChar),
    ...
    public static class SyslogExtension implements BeforeAllCallback, AfterAllCallback,
        BeforeEachCallback {
        @Override
    ...
    class SyslogMessageHandlerTest implements TestUtils.TestWithLogCapture {
        ...
        @Test
        public void test_syslog_handler_should_filter_invalid_message()
        ...
        public void test_syslog_handler_should_use_facility() throws InterruptedException {
            ...
            String splitChar = ">";
            syslogServer.addHandler(
                new LoggingUtils.SyslogMessageHandler(Neo4jResource.class.getName(), facility0,
                    splitChar));

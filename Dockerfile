...
RUN curl -sSL https://install.python-poetry.org | POETRY_HOME=$HOME/.local/share/pypoetry POETRY_VERSION=1.3.1 python3.10 -
...
ADD .data/tmp/.gitignore $HOME/.data/tmp/.gitignore
